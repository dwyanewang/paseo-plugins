...
export interface TodoActions {
  ...
  create: (
    input: { projectId: string; projectNameSnapshot: string; projectRootSnapshot?: string; title: string; details: string; defaultPrompt: string; images?: WorkItemImageInput[]; files?: WorkItemFileInput[]; status?: "backlog" | "todo"; priority?: WorkItemPriority },
    identity: WorkItemIdentity,
  ) => Promise<WorkItem | null>;
  update: (item: WorkItem, patch: { title?: string; details?: string; defaultPrompt?: string; priority?: WorkItemPriority; images?: WorkItemImageInput[]; files?: WorkItemFileInput[] }) => Promise<boolean>;
